...
exports.findPythonFunctionEnd = exports.getLanguagePattern = exports.LANGUAGE_PATTERNS = void 0;
...
function getLanguagePattern(fileName) {
    const extension = fileName.substring(fileName.lastIndexOf('.'));
    return exports.LANGUAGE_PATTERNS.find(pattern => pattern.extensions.includes(extension)) || null;
}
exports.getLanguagePattern = getLanguagePattern;
...
exports.findPythonFunctionEnd = findPythonFunctionEnd;
